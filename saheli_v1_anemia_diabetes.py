...
logging.basicConfig(
    level   = logging.DEBUG,                 # INFO is plenty; use DEBUG for more noise
...
def retrieve_relevant_chunks(prompt, selected_condition, top_k=5):
    ...
    log.debug(f"nutri_hits: {nutrit_hits}")
